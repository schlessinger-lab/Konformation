...
def Data2Pandas( Data, output ):
  ...
  # Columns of data to be reordered and to print out 
  columns = [ 'pdb_id',
  ...
  # Output to CSV
  parm_df.to_csv(output+'.csv', sep=',', na_rep='NA', encoding='utf-8',
                  float_format='%.5f', header=True )

  # Output to Excel
  parm_df.to_excel(output+'.xlsx', header=True , na_rep='NA')
